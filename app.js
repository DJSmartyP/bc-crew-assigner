...
function responseRow(p,plan){
  ...
  const currentText=assignment?`<span class="assignment-summary">${multiShip&&assignmentShip?`${esc(displayShip(assignmentShip,assignmentShipIndex))} · `:""}${esc(assignment.role)}</span>`:"<span class="assignment-summary">Not assigned yet</span>";
